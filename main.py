...
# Links in href are taken from all_link_elements.
...
# If $ exists it is looped else skipped, /mo is replaced with whitespace, $1200+$100 is split to $1200,$100 and [0] is taken ie:1200.
...
#keep the browser open until we close it.
...
for n in range(len(all_links)):
    ...
    driver.get("https://docs.google.com/forms/d/e/1FAIpQLSfi4HcDHmjP6Jt7Yn_0H8xjNCdr-qzFJChqJYpwunwhAgPCxQ/viewform?usp=header")
    time.sleep(2)
